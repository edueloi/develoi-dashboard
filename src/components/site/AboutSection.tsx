    ...
    <section className="relative py-24 dash-bg transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-indigo-600 font-black uppercase tracking-widest text-sm mb-4">Quem somos</h2>
            <h3 className="text-4xl md:text-5xl font-black dash-text mb-6 tracking-tighter leading-tight">
              Somos mais do que uma empresa de <span className="text-gradient">tecnologia.</span>
            </h3>
            
            <div className="space-y-6 dash-text-2 text-lg leading-relaxed mb-8">
              <p>
              ...
              <p className="font-semibold dash-text text-xl border-l-4 border-indigo-600 pl-4 py-2 bg-indigo-500/5">
          ...
          >
            {[
              ...
              <div key={idx} className="dash-surface p-6 rounded-2xl flex flex-col gap-4 border dash-border hover:dash-surface-2 shadow-sm transition-all">
                <div className="w-12 h-12 rounded-xl bg-indigo-500/10 flex items-center justify-center">
                  <card.icon className="w-6 h-6 text-indigo-600" />
                </div>
                <div>
                  <h4 className="dash-text font-bold text-lg mb-1">{card.title}</h4>
                  <p className="dash-text-2 text-sm">{card.desc}</p>
                </div>
              </div>
            ))}
          </motion.div>
